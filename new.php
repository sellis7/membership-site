...
*	Date:   03-01-2014
*
*	This script registers new users once they try to log in
*       and return no results. I'm not too sure about the "login"
*       part, as it seems that it can't be styled. Perhaps due to sessions... 
*       
*=====================================
*/
...
if (isset($_POST['submitted'])) {
	...
	if (empty($errors)) { // If everything's OK.
		...
		<p class="update">You are now registered.</p><p><br /></p>';	
