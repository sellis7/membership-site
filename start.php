...
*	Date:   03-01-2014
*
*	This script seems to allow for registering new members/users
*       but to be honest, it appears to be quite a mess
*       of some unused elements, and I'm not sure how it all works
*
*=====================================
*/
